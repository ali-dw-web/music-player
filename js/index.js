 window.addEventListener('load', () => {
    ...
    document.getElementsByClassName('icon-play')[0].addEventListener('click', () => {
        if (flag % 2) {
            document.getElementsByClassName('icon-play')[0].setAttribute('class', ' icon-pause')
            track.play()
            document.getElementsByClassName('icon-pause')[0].setAttribute('data-state', 'on')


        } else {
            document.getElementsByClassName('icon-pause')[0].setAttribute('class', ' icon-play')
            track.pause()
            document.getElementsByClassName('icon-play')[0].setAttribute('data-state', 'off')
        }
        flag++
    })
    function inf() {
